...
This connector supports set lpush and rpush write operations through the `redis.insertion.type` configuration attribute.
...
*Validator:* Matches: ``SET``, ``LPUSH``, ``RPUSH``
